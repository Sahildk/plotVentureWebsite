...
export default async function HomePage() {
    ...
    features: [
      {
        ...
        description:
          "Strategically located in prime areas with excellent connectivity and amenities.",
        icon: "Home",
      },
      {
        id: 2,
        ...
        description:
          "Trusted developer with a proven track record of successful projects.",
        icon: "Shield",
      },
      {
        id: 3,
        title: "High Returns",
        description:
          "Invest in properties with exceptional growth potential and value appreciation.",
        icon: "TrendingUp",
      },
      {
        id: 4,
        ...
        description:
          "Close to schools, hospitals, shopping centers, and major business districts.",
        icon: "MapPin",
      },
      {
        id: 5,
        ...
        description:
          "Experience a vibrant community with modern amenities and facilities.",
        icon: "Users",
      },
      {
        id: 6,
        ...
        description:
          "Built with premium materials and attention to detail in every aspect.",
        icon: "Award",
      },
    ],
  };
  ...
  const aboutData: AboutSection = {
    ...
    content:
      "Plot Venture is a leading real estate developer committed to creating exceptional living spaces. With years of experience and a passion for excellence, we deliver premium properties that exceed expectations.",
    image: {
      id: 0,
  ...
  const ctaData: CTASection = {
    ...
    description:
      "Schedule a site visit today and experience the Plot Venture difference. Our team is ready to help you find the perfect property.",
    buttons: [
      {
        id: 1,
        label: "Book a Site Visit",
